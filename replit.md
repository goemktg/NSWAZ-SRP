...
- `srp_process_log` - Audit log tracking all SRP request state changes (created, approved, denied, paid) with timestamps and actor names. Status is derived from the latest process log entry.
